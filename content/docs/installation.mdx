...
You can add components to your project using either the CLI or manually copy the code.

<InstallationSteps
  componentName="blur-highlight"
  dependencies={['react']}
  code={`"use client";
...
export default function Page() {
  return (
    <BlurHighlight highlightedBits={['installation']}>
